...
class GitTagPlugin {
    ...
    apply(auto) {
        ...
        auto.hooks.next.tapPromise(this.name, async (preReleaseVersions, { bump, dryRun }) => {
            ...
            const prereleaseBranches = (_b = (_a = auto.config) === null || _a === void 0 ? void 0 : _a.prereleaseBranches) !== null && _b !== void 0 ? _b : core_1.DEFAULT_PRERELEASE_BRANCHES;
            ...
            const prerelease = auto.prefixRelease(core_1.determineNextVersion(lastRelease, current, bump, prereleaseBranch));
